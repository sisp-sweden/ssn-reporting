Your theme is automatically synced to code when you run the CLI.
To update your theme manually, replace your tailwind.config.js file with the following code.
